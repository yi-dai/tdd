...
public class MommifierTest {
    ...
    void should_return_itself_when_string_is_null(){
        ...
        //then
        assertEquals(string_with_less_30_vowels.toString(),result);
    }
    @Test
    void should_return_itself_when_vowels_less_30(){
        //given
        String string_with_less_30_vowels = "abcdf";
        //when
        Mommifier mommifier = new Mommifier();
        String result = mommifier.convert(string_with_less_30_vowels);
        //then
    ...
    void should_return_itself_when_vowels_is_not_continuous(){
        ...
        //then
        assertEquals(string_with_not_continuous_vowels.toString(),result);
    }
